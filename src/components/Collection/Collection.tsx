          ...
          <AppBar position="fixed" className={clsx(classes.appBar, {[classes.appBarShift]: open })}>
              <Toolbar className={classes.toolbar}>
                  ...
                  <Typography variant="h6" className={classes.font} noWrap>
                      Bike Collection List
                  </Typography>
                  <Button className={classes.toolbar_button} onClick={handleDialogClickOpen}>Create New Bike</Button>

                  {/* Dialog Pop Up */}
                  <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby="form-dialog-title">
                      <DialogTitle id="form-dialog-title">Add New Bike</DialogTitle>
                      <DialogContent>
